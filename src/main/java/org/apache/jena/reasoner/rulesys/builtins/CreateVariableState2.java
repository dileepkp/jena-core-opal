...
public class CreateVariableState2 extends BaseBuiltin {
    ...
    @Override
     public boolean bodyCall(Node[] args, int length, RuleContext context) {
        ...
        int stateValue = Bdd.getStateValue(getArg(2, args, context));
          //int stateValue =  (int) getArg(2, args, context).getLiteralValue();
        String stateRelation = getArg(3, args, context).toString();
      
     
        makeState(variable, pp, stateValue, stateRelation);
...
*/
    ...
    public void makeState(String variable, String pp, int stateValue, String stateRelation) {
        ...
        BDD bb = ppBdd.and(varBdd).and(valueBdd).and(stateRelationBdd);
