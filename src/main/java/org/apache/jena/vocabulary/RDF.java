...
public class RDF{
    ...
    */
    ...
    public static final Property    item        = Init.item();
    ...
    public static class Init {
        ...
        public static Property item()            { return property( "item" ); }
        public static Property li()            { return property( "li" ); }
    ...
    */
    ...
    public static final class Nodes
    {
        ...
        public static final Node item      = Init.item().asNode();
        public static final Node li      = Init.li().asNode();
